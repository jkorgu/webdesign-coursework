...
function delight() {
    document.getElementById("member1").style="border: none; filter: blur(5px);"
}
...
//Adds a blur on the image and removes border when mouse goes away
function delight2() {
    document.getElementById("member2").style="border: none; filter: blur(5px);"
}
...
//Adds a blur on the image and removes border when mouse goes away
function delight3() {
    document.getElementById("member3").style="border: none; filter: blur(5px);"
}
...
//Adds a blur on the image and removes border when mouse goes away
function delight4() {
    document.getElementById("member4").style="border: none; filter: blur(5px);"
}
...
//Adds a blur on the image and removes border when mouse goes away
function delight5() {
    document.getElementById("member5").style="border: none; filter: blur(5px);"
}
