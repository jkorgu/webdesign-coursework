...
//Adds a blur on the image and removes border when mouse goes away
function delight() {
    document.getElementById("img-gallery1").style="border: none; filter: blur(5px);"
}
...
//Adds a blur on the image and removes border when mouse goes away
function delight2() {
    document.getElementById("img-gallery2").style="border: none; filter: blur(5px);"
}
...
//Adds a blur on the image and removes border when mouse goes away
function delight3() {
    document.getElementById("img-gallery3").style="border: none; filter: blur(5px);"
}
...
//Adds a blur on the image and removes border when mouse goes away
function delight4() {
    document.getElementById("img-gallery4").style="border: none; filter: blur(5px);"
}
...
//Adds a blur on the image and removes border when mouse goes away
function delight5() {
    document.getElementById("img-gallery5").style="border: none; filter: blur(5px);"
}
...
//Adds a blur on the image and removes border when mouse goes away
function delight6() {
    document.getElementById("img-gallery6").style="border: none; filter: blur(5px);"
}
...
//Adds a blur on the image and removes border when mouse goes away
function delight7() {
    document.getElementById("img-gallery7").style="border: none; filter: blur(5px);"
}
...
//Adds a blur on the image and removes border when mouse goes away
function delight8() {
    document.getElementById("img-gallery8").style="border: none; filter: blur(5px);"
}
...
//Adds a blur on the image and removes border when mouse goes away
function delight9() {
    document.getElementById("img-gallery9").style="border: none; filter: blur(5px);"
}